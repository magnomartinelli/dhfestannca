  ...
  return (
    <section className="relative w-full pt-12 md:pt-20 pb-20 md:pb-28 flex flex-col items-center text-center px-4 overflow-hidden">
      ...
      <div className="mt-16 md:mt-20 flex flex-wrap justify-center items-center gap-4 md:gap-8 text-slate-400 text-[10px] md:text-xs font-bold tracking-[0.1em] md:tracking-[0.2em] uppercase">
        <span className="flex items-center gap-1.5 bg-white/40 px-3 md:px-5 py-2 md:py-2.5 rounded-lg md:rounded-xl border border-white/50 shadow-sm"><Sparkles size={12} className="text-pink-400" /> ARTE EXCLUSIVA</span>
        <span className="flex items-center gap-1.5 bg-white/40 px-3 md:px-5 py-2 md:py-2.5 rounded-lg md:rounded-xl border border-white/50 shadow-sm"><Sparkles size={12} className="text-blue-400" /> BALLOON DESIGN</span>
        <span className="flex items-center gap-1.5 bg-white/40 px-3 md:px-5 py-2 md:py-2.5 rounded-lg md:rounded-xl border border-white/50 shadow-sm"><Sparkles size={12} className="text-purple-400" /> AFETO REAL</span>
      </div>
